...
export function PodcastBanner() {
  return (
    <section className="podcast-banner" aria-label="Podcast Strong Girl Boss">
      <div className="podcast-cover"><img src="https://raw.githubusercontent.com/essidyoussef-source/mathildewod/main/client/public/manus-storage/sgb-podcast-cover_f1e1d16e.jpg" alt="Cover officiel du podcast Strong Girl Boss" /></div>
