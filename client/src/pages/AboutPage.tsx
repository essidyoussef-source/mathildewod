...
export default function AboutPage() {
  return (
    <div className="editorial-page about-page"><SiteNav /><main>
      <section className="about-hero"><div className="editorial-shell about-hero-grid"><div><p className="page-kicker">À propos</p><h1>Une méthode pour que ta passion devienne une marque qui <em>rayonne.</em></h1><p>Je suis Mathilde. J’aide les femmes à sortir du contenu posté au hasard, à affirmer leur identité et à créer une visibilité capable de soutenir leurs ambitions.</p><a className="about-apply" href={APPLY_CREATOR} target="_blank" rel="noreferrer">Candidater <ArrowUpRight size={16} /></a></div><figure><img src="https://raw.githubusercontent.com/essidyoussef-source/mathildewod/main/client/public/manus-storage/mathilde-hero_66e375c3.png" alt="Mathilde, fondatrice de MathildeWod" /><figcaption>MathildeWod — Coach visibilité & création de contenu</figcaption></figure></div></section>
